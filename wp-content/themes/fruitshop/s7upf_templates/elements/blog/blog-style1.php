            ...
            <article class="item-blog-list mb-item-blog-list <?php echo (is_sticky()) ? 'sticky':''?>">
                ...
                <div class="blog-info border bg-white">
                    ...
                    <ul class="list-inline-block blog-comment-date">
                        ...
                        <li><label><?php echo esc_html__('Fecha: ','fruitshop'); ?></label><span class="color"><?php echo get_the_date($data_date); ?></span></li>
                        <li>
                            <label> <?php
                    ...
                    <div class="table social-readmore">
                        <div class="text-left">
                            <a href="<?php echo esc_url(get_the_permalink()); ?>" class="shop-button"><?php esc_html_e('Leer más','fruitshop')?></a>
                        </div>
