...
switch ($style){
    case 'style1':
        ?>
        <div class="<?php echo esc_attr($extra_class); ?> item-adv1 overlay-image banner-adv mb-banner-element1 <?php echo esc_attr($class_height_info); ?> <?php echo esc_attr($animation_bg); ?>">
    ...
    case 'style2':
        $s = 0.4;
        ?>
        <div class="<?php echo esc_attr($extra_class); ?> <?php if($position_info == 'left') echo 'hoz-banner';?> banner-guide <?php echo esc_attr($animation_bg);?> overlay-image banner-adv">
    ...
    case 'style4':
            ...
            <div class="mb-banner-style-5 <?php echo esc_attr($extra_class); ?>">
                <div class="banner-adv item-adv5 overlay-image zoom-rotate">
    ...
    case 'style5':
        ...
        <div class="item-adv7 banner-adv  <?php echo esc_attr($animation_bg); ?>  <?php echo esc_attr($class_color); ?> overlay-image <?php echo esc_attr($extra_class); ?>">
            <a href="<?php echo (!empty($data_button['url']))? esc_url($data_button['url']): '#'; ?>" <?php if(empty($data_button['url'])) echo 'onclick="return false;"'; ?> target="<?php echo (!empty($data_button['target']))?'_blank':'_parent'; ?>" class="adv-thumb-link">
                <?php if($animation_bg === 'zoom-out'){ ?>
                    <?php echo wp_get_attachment_image($bg_image,$image_size,false, array('class'=>'img-1'));
                    if(!empty($bg_image_out)){
    ...
    case 'style6':
        ...
        ?>
        <div class="item-adv8 banner-adv  <?php echo esc_attr($animation_bg); ?> <?php echo esc_attr($extra_class); ?>">
    ...
    default :
        $class_color=''; if(!empty($bg_info)) $class_color = S7upf_Assets::build_css('background:'.$bg_info.';');
         ?>
        <div class="item-banner10 banner-adv zoom-image  <?php echo esc_attr($extra_class); ?>">
            <a href="<?php echo (!empty($data_link_banner['url']))? esc_url($data_link_banner['url']): '#'; ?>" <?php if(empty($data_link_banner['url'])) echo 'onclick="return false;"'; ?> target="<?php echo (!empty($data_link_banner['target']))?'_blank':'_parent'; ?>" class="adv-thumb-link">
