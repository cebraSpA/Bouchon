...
switch ($format){
    case 'image':
        if(has_post_thumbnail()) { ?>
            <div class="banner-adv <?php echo esc_attr($img_hover); ?> zoom-image mb-media index-bajo">
                <a href="<?php the_permalink(); ?>" class="adv-thumb-link index-bajo"><?php the_post_thumbnail($size_image); ?></a>
            </div>
        <?php }
        break;
    case 'gallery':
        if(!empty($data_gallery) and is_array($data_gallery)){
            ?>
            <div class="post-gallery mb-media-post mb-media index-bajo">
                <div class=" smart-slider index-bajo" data-item = "1" data-itemres="0:1" data-speed = "5000" data-navigation="true" >
                    <?php
                    foreach ($data_gallery as $value){?>
                        <div class="image-slider12 index-bajo banner-adv <?php echo esc_attr($img_hover); ?> zoom-image">
    ...
    default:
        if(has_post_thumbnail()) { ?>
            <div class="banner-adv index-bajo <?php echo esc_attr($img_hover); ?> zoom-image mb-media">
                <a href="<?php the_permalink(); ?>" class="adv-thumb-link index-bajo"><?php the_post_thumbnail($size_image); ?></a>
            </div>
        <?php }
        break;
