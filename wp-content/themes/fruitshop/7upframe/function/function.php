...
if(!function_exists('s7upf_display_breadcrumb'))
{
    function s7upf_display_breadcrumb()
    {
        ...
        if($enable_banner == 'on'){
            ?>
            <div class="mb-banner-pro shop-banner banner-adv line-scale zoom-image <?php if(empty($bg_image_banner)) echo 'mb_no_image_banner'; ?>">
        ...
        switch ($type) {
            case 'blog':?>
                <ul class="list-inline-block blog-comment-date">
                    <li class="mb-category"><label><?php echo esc_html__('Categoría: ','fruitshop'); ?></label><?php echo get_the_category_list(', ');?></li>
                    <li><label><?php echo esc_html__('Fecha: ','fruitshop'); ?></label><span class="color"><?php echo get_the_date(get_option('date_format')); ?></span></li>
                    <li>
                        <label> <?php
                            if(get_comments_number()>1) esc_html_e('Comentarios: ', 'fruitshop') ;
                            else esc_html_e('Comentario: ', 'fruitshop') ;
                            ?>
                        </label>
            ...
            case 'share_post':?>
                <div class="text-right blog-social">
                    <span><?php echo esc_html__('Compartir: ','fruitshop'); ?></span>
                        ...
                        if ($cats) { ?>
                            <div class="text-left">
                                <div class="single-tabs">
                                    <?php
                                    if ((int)$count_tag > 1) { ?>
                                        <span><?php echo esc_html__('Tags: ', 'fruitshop');
                    ...
                    if(get_previous_post() || get_next_post()) { ?>
                        <div class="single-post-control table">
                            ...
                            <div class="text-left post-control-prev">
                                <?php previous_post_link('%link', esc_html__('Anterior','fruitshop')); ?>
                            ...
                            <div class="text-right post-control-next">
                                <?php next_post_link('%link',  esc_html__('Siguiente','fruitshop')); ?>
...
if(!function_exists('s7upf_mini_cart')) {
    function s7upf_mini_cart($echo = false)
    {
        ...
        if (!WC()->cart->is_empty()) {
            ?>
            <h2 class="title18 color cart-item-count">(<span><?php echo count( WC()->cart->get_cart() );?></span>)<?php echo(count( WC()->cart->get_cart() )>1)? esc_html__(' ITEMS EN MI CARRITO','fruitshop'): esc_html__(' ITEM EN MI CARRITO','fruitshop'); ?> </h2>
            ...
            <div class="mini-cart-total  clearfix">
                ...
                <span class="pull-right color title18"><?php echo WC()->cart->get_cart_total(); ?></span>
            </div>
            <div class="mini-cart-button">
                <a class="mini-cart-view shop-button" href="<?php echo esc_url(wc_get_cart_url())?>"><?php echo esc_html__('Ver Carrito','fruitshop')?></a>
                <a class="mini-cart-checkout shop-button" href="<?php echo esc_url(wc_get_checkout_url())?>"><?php echo esc_html__('Comprar','fruitshop')?></a>
            </div>
            <?php
        }else{
            ?>
            <h5 class="mini-cart-head"><?php echo esc_html__("No hay productos en tu carrito.","fruitshop")?></h5>
            <?php
        }
    }
}
