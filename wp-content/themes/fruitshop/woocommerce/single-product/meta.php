...
<div class="product_meta desc info-extra">
    ...
    <p class="posted_in">
        <label>
            <?php echo(count( $product->get_category_ids() )>1)?esc_html__('Categoría:','fruitshop'):esc_html__('Categoría:','fruitshop')?>
       </label>
    ...
    <p class="posted_in">
        <label>
            <?php echo(count( $product->get_tag_ids() )>1)?esc_html__('Etiquetas:','fruitshop'):esc_html__('Etiqueta:','fruitshop')?>
        </label>
