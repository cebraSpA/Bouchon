...
class Ultimate_Post_List_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		// print the list
		echo Ultimate_Post_List_Public::print_list( $args );
	...
	/*public function enqueue_public_style () {
		...
		if ( ! file_exists( $this->css_file_path ) and class_exists( 'Ultimate_Post_List_Public' ) ) {
			// make the file
			$is_available = Ultimate_Post_List_Public::make_css_file();
		}
		...
		if ( $is_available ) {
			wp_enqueue_style(
				...
				plugin_dir_url( dirname( __FILE__ ) ) . 'public/css/ultimate-post-list-public.css',
				array(),
				$this->plugin_version,
				'all' 
			);
	...
	*/
	...
	/*public function enqueue_admin_style () {
		...
		wp_enqueue_style(
			...
			plugin_dir_url( dirname( __FILE__ ) ) . 'admin/css/ultimate-post-list-admin.css',
			array(),
			$this->plugin_version,
			'all' 
		);
