...
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=KMNHCY3MZ6D2N
...
Promote your website’s content with many kinds of post lists. No programming skills are necessary. With just a few keyboard entries and clicks you get a customized posts list. The plugin Ultimate Post List for WordPress gives you an easy-to-use toolbox to make lists of posts.

You can insert the lists
...
The plugin is available in English, German (Deutsch) and Greek (Ελληνικά).
...
* **List Layout Options**
	...
	* **List Item Layout Options**
	    List item layout type (text floats around or is next to the thumbnail)
...
The Pro version has all the options of the free version and many additional options for layouts, colors, custom post types and much more. [Go to Ultimate Post List Pro](https://shop.stehle-internet.de/downloads/ultimate-post-list-pro/).

= Useful hints for developers =

See all informations about shortcode attributes and function parameters in the [Developer Notes](https://shop.stehle-internet.de/developer-notes-for-ultimate-post-list-pro/) of the Pro version. You can use all informations both in this free version and the Pro version.
...
3. Select `ultimate-post-list.zip` from your computer
4. Click 'Install Now'
...
2. Extract the `ultimate-post-list` directory to your computer
3. Upload the `ultimate-post-list` directory to the `/wp-content/plugins/` directory
...
* Added new function upl_print_list() to call a list in PHP code, documented in the [Developer Notes](https://shop.stehle-internet.de/developer-notes-for-ultimate-post-list-pro/)
