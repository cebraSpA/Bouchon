...
(function( $ ) {
	 ...
	 */
		$('.jt__changeimg').live('click', function( event ){
	 ...
	 */
		...
		$(".team_design_v").live('click', function() {
		...
		$(".team_design_h").live('click', function() {
		...
		/* Tabs Selector*/
		$(".jt__tabs li").live('click', function() {
			var thisTab = $(this);
		...
		$(".jt__resetTeamSettings").live('click', function(e) {
			e.preventDefault();
