...
class JWD_Teams_Hooks {
	...
	public function get_fa_icon($icon, $style = '', $title = '') {
		...
		/* Get the icon */
		$output .= '<i class="fa '.$icon.'" aria-hidden="true" '.$icon_style.' '.$icon_title.'></i> '; 
		return $output;
	}
	/**
	...
	public function get_team_settings($team_grid_style = '') {
		$settings = array(
			...
			'team_design' 	=> array(
				...
				'default'		=> 'vertical',
				'choices'		=> array(
					'team_design_v'	=> array( 'value' => 'vertical', 'lb_title' => __( 'Vertical', $this->textdomain ), 'lb_icon' => 'fa-th-list fa-rotate-90' ), 
					'team_design_h'	=> array( 'value' => 'horizontal', 'lb_title' => __( 'Horizontal', $this->textdomain ), 'lb_icon' => 'fa-th-list' )
				)
			),
			...
			'team_settings_img' => array(
				...
				'choices'		=> array( 
					'member_img_circle' => array( 'value' => 'member_img_circle', 'lb_title' => __( 'Disc', $this->textdomain ), 'lb_icon' => 'fa-circle' ),
					'member_img_square'	=> array( 'value' => 'member_img_square', 'lb_title' => __( 'Square', $this->textdomain ), 'lb_icon' => 'fa-stop' )
				)
			),
			'team_settings_desc' => array(
				...
				'choices'		=> array(
					'member_desc_list' 		=> array( 'value' => 'member_desc_list', 'lb_title' => __( 'List item', $this->textdomain ), 'lb_icon' => 'fa-list' ),
					'member_desc_tooltip' 	=> array( 'value' => 'member_desc_tooltip', 'lb_title' => __( 'Tooltip', $this->textdomain ), 'lb_icon' => 'fa-commenting' )
				)
			),
			'team_txt_align' => array(
				...
				'default'		=> 'txt_center',
				'choices'		=> array( 
					'team_txt_align_left' 	=> array( 'value' => 'txt_left', 'lb_title' => __( 'Align left', $this->textdomain ), 'lb_icon' => 'fa-align-left' ),
					'team_txt_align_center'	=> array( 'value' => 'txt_center', 'lb_title' => __( 'Align center', $this->textdomain ), 'lb_icon' => 'fa-align-center' ),
					'team_txt_align_right'	=> array( 'value' => 'txt_right', 'lb_title' => __( 'Align right', $this->textdomain ), 'lb_icon' => 'fa-align-right' )
				)
			),
			'team_desc_justify'		=> array( 'type' => 'checkbox', 'id' => 'team_desc_justify', 'value' => 'yes', 'lb_icon' => 'fa-align-justify', 'lb_content' => __( 'Justify Description', $this->textdomain ) ),
